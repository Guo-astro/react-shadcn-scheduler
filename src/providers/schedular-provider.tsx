...
export const SchedulerProvider = ({
  ...
  onAddEvent?: (event: ModalEvent) => void;
  onUpdateEvent?: (event: ModalEvent) => void;
  onDeleteEvent?: (id: string) => void;
  weekStartsOn?: startOfWeek;
  children: ReactNode;
  initialState?: ModalEvent[];
}) => {
  ...
  // handlers
  function handleEventStyling(event: ModalEvent, dayEvents: ModalEvent[]) {
  ...
  function handleUpdateEvent(event: ModalEvent, id: string) {
